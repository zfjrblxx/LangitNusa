...
const sources = [
  ...
  ['Kualitas udara', 'BMKG', 'Pemantauan PM2.5 resmi BMKG. LangitNusa memilih stasiun BMKG terdekat yang tersedia dan menampilkan nilai, kategori, waktu pembaruan, serta jarak stasiun.', 'https://www.bmkg.go.id/kualitas-udara/pm25'],
...
export default function AboutData() {
  return <section className="section about-data" id="about-data">
    ...
    <div className="data-principles">
      ...
      <div><CloudSun size={17} /><strong>Interpretasi diberi konteks</strong><span>Skor lingkungan dan kesiapan aktivitas adalah interpretasi LangitNusa dari data BMKG, bukan indeks resmi BMKG.</span></div>
    </div>
